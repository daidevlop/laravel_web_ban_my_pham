...
@section('contents')
    <div id="product-info" class="container  mt-4">
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="https://www.flowercorner.vn?route=common/home"><i class="fas fa-home">
                    </i></a></li>
        ...
        <div class="row">
            <div id="content" class="col">
                <div class="row mb-3">
                    ...
                    <div class="col-sm po-relative">
                        ...
                        <ul class="list-unstyled price-box">
                            <li>
                                <h3><span class="price-new">{{$detailProduct->price}}VND</span></h3>
                            </li>
                        </ul>
                            ...
                            <form id="form-product">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="quantity" value="1" size="2" id="input-quantity"
                                        class="form-control" /> <input type="hidden" name="product_id" value="7609"
                                        id="input-product-id" />
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item"><a href="#tab-description" data-bs-toggle="tab" class="nav-link active">Mô tả sản
                            phẩm</a></li>
                </ul>
                <div class="tab-content">
                    <div id="tab-description" class="tab-pane fade show active mb-4">
                        ...
                        <p><span style="font-size:14px"><span style="font-family:Arial,Helvetica,sans-serif"><em>**Do được
                                        làm thủ công, nên
                                        ...
                                        ảnh.</em></span></span></p>
                        <p><span style="font-size:14px"><span style="font-family:Arial,Helvetica,sans-serif"><em>**Vì các
                                        loài hoa thay đổi
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-xl-4">
                <div class="col">
                    <form method="post" data-oc-toggle="ajax"
                        data-oc-load="https://www.flowercorner.vn?route=common/cart|info" data-oc-target="#header-cart">
                            ...
                            <div class="image p-relative">
                                <a href="gio-hoa-cuc-trang-6228.html">
                                    <img src="../image/catalog/1px.webp" width="261" height="326"
                                        ...
                                        alt="Giỏ Hoa Cúc Trắng" title="Giỏ Hoa Cúc Trắng" class="img-fluid lozad" />
                                </a>
                            </div>
                            <div class="content">
                                <div class="description">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6 mb-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="senderphone" placeholder value
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-6">
                                        <div class="g-recaptcha" data-sitekey="6LeQyycpAAAAAMghgRAuDG-4q6XWEeVxnJtIgY1Y">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
