...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            {{-- <li class="nav-item">
                <a class="nav-link collapseds" href="#" data-toggle="collapses" data-target="#collapsePagess"
                    aria-expanded="true" aria-controls="collapsePagess">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Quản lý tài khoản</span>
                </a>
                <div id="collapsePagess" class="collapses" aria-labelledby="headingPagess" data-parent="#accordionSidebars">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="{{route('account-admin.index')}}">
